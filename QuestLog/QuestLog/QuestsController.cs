...
namespace QuestLog
{
    public class QuestsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "QuestID,Name,Level,Alignment,Reward,ExperiencePoints")] Quest quest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "QuestID,Name,Level,Alignment,Reward,ExperiencePoints")] Quest quest)
        {
            if (ModelState.IsValid)
            {
